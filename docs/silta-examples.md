...
Note 2: Because of [long-standing bugs in the ssmtp package](https://serverfault.com/questions/826875/what-characters-are-illegal-in-password-in-ssmtp-conf), __the smtp password cannot contain the special characters `#`, `=` or `:`__. 
